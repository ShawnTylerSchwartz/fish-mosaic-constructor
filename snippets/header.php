<?php
	...
	// (c) Alfaro Lab UCLA 2019
	//
?>

<!-- FishMosaicSampling_Interface for Subsampling Scaled Fish Images -->
<!-- (c) Alfaro Lab UCLA 2019 -->
<!-- By Shawn Tyler Schwartz <shawnschwartz@ucla.edu> -->
<!-- https://shawntylerschwartz.com -->
...
<html lang="en">
	<head>
		...
		<title>Fish Mosaic Constructor</title>
		...
		<!-- <script language="JavaScript" type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script> -->
